...
class TestesBaseDeDados(unittest.TestCase):
    ...
    def teste_retorna_serie_nome(self):
        ...
        registro_esperado = Registro(10, Serie('Good Omens', 'Comédia, Fantasia', 6, 55, 1, 2019, ['Michael Sheen', 'David Tennant', 'Frances McDormand', 'Jon Hamm']), 'Lindo, Belo e Bem Gay. É uma das minhas favoritas do Neil Gaiman.', True)
    ...
    def teste_retorna_livro_nome(self):
        ...
        registro_esperado = Registro(10, Livro('1984', 'Drama, Distopia, Ficção Científica', ['George Orwell'], 354, 1949), 'Obra prima sem igual. Não importa quando ou quantas vezes você o leia, sempre haverá uma percepção de algum aspecto da sociedade que você não tinha visto antes. Praticamente uma profecia do mundo pós moderno. Não é uma leitura fácil, definitivamente. Mas vale muito a pena.', True)
